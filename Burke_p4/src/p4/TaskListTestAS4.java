...
class TaskListTest {
	  @Test
	    ...
	    void editingTaskItemTitleChangesValue(){
	        TaskList list = new TaskList();
	        TaskItem newItem = new TaskItem("Task Item 1", "2022-05-08", "Task Description 1", false);
	        list.taskList.add(newItem);
	        TaskItem editItem = new TaskItem("Task Item 2", "2023-05-08", "Task Description 2", false);
	        list.taskList.set(0,editItem);
	        assertEquals("Task Item 2", list.taskList.get(0).getName());
	    }
	    @Test
	    void editingTaskItemTitleFailsWithInvalidIndex(){
	        TaskList list = new TaskList();
	        new TaskItem("Zach Burke", "1998-08-23", "This is my birthday.", false);
	        assertThrows(IndexOutOfBoundsException.class, () -> { list.taskList.get(2).setName("Virgo");});
	    }
	    @Test
	    void gettingTaskItemDescriptionFailsWithInvalidIndex(){
	        TaskList list = new TaskList();
	        TaskItem newItem = new TaskItem("Testing", "2050-08-23", "Test Description", false);
	        list.taskList.add(newItem);
	    ...
	    void gettingTaskItemDueDateFailsWithInvalidIndex(){
	        TaskList list = new TaskList();
	        TaskItem newItem = new TaskItem("Test", "2050-08-23", "Testing", false);
	        list.taskList.add(newItem);
